...
const TodaysTask = ({ src }: { src: string }) => {
  return (
    <div className='p-6  mb-6 min-w-[240px]  md:min-w-[350px] bg-secondary flex flex-col gap-4 rounded-lg min-w'>
      <span className="font-bold">Task Today</span>
      ...
      <div className="w-full flex flex-col ">
        ...
        <div className="flex flex-col">
          <div className="flex justify-between">
            <span className="font-bold ">Detail Task</span>
          ...
          <button className="rounded-xl bg-primary/500 text-white mt-8 py-4" > Go To Detail</button>
